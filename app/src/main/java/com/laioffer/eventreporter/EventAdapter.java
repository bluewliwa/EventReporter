...
public class EventAdapter extends BaseAdapter {
    ...
    public EventAdapter(Context context, List<Event> eventList) {
        ...
        SharedPreferences prefs = this.context.getSharedPreferences("loginUser",Context.MODE_PRIVATE);
        this.username = prefs.getString("username","unknown");
        System.out.format("current login username : %s.......\n",this.username);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (type == TYPE_ADS) {
            ...
            class Good {
                ...
                public Good(String username, String eventid) {
                    this.username = username;
            ...
            holder.img_view_good.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    databaseReference.child("good").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                ...
                                if (recordedevent.getId().equals(event.getId())) {
                                    ...
                                    //if (databaseReference.child(username)) {
                                        ...
                                        //databaseReference.child("good").child(username).setValue(username);
                                        //databaseReference.child("good").child(username).child(event.getId()).setValue(event.getId());
                                        break;
                                    //}
                                }
